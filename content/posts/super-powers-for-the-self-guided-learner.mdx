...
some sort of superpower to remember eveything that we learn forever? Well, not
...
persistance**. Drive can come from within or from external factors like monetary
incentives, but you need to find what motivates you and then persistantly apply
...
Maintain that drive and persistance, and you will get to where you want to be.
...
recieve. Failure is essential to improvement.
...
The most valubale skills to stack are ones that are compatible, but are
...
Don't believe everyting one particular leader alone says. It's true, there are
great people with admirable achievments, but their's are only one person's
perspective.
...
disadvantages. Somone with a wealthy family may have more oppurtunities in life
...
I mentioned this in my introduction - In order to really understnad a topic, you
...
where cognititve efficiency depletes.

**Brain training** strengthens the connctions (synapses) between brain cells
(neurons).
...
four chunks of information to be stored. Spaced repition is used to transfer
into long term memory, when the synapses are strengthened.

**Active vs passive learning**: Active engagement is more effetive than passive
learning. Passivly watching a lecture creates and illusion of competence.
...
**Small steps** in completing goals eliminates the fear of faulire. Breaking
...
reached. Concentrate on things just outsite of your cognitive ability. There are
...
**Spaced repition** is the best way to create long term memory by strengthening
synaptic neurons.
...
people have dedicated coutnless hours to these findings over a long period of
time. Therfore I will be aplpying these techniques to my future learning

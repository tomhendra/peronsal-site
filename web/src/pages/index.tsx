      ...
      <Grid>
        ...
        >
          ...
          <Text variant="secondary">
            I am at my happiest when crafting buttery smooth web experiences. I
            take pride in continuously learning new skills from the experts who
            shape the modern web.
          </Text>
          <Text noSpacingBottom variant="secondary">
            When I am not in the land of code, I am either immersing myself in
            the wonderful culture & cuisine of Spain or lifting heavy things at
            the gym.
          </Text>
        </Item>
        <Item
        ...
        <Item gridColStart={[1, 2, 3, 4, 9]} gridColEnd={[9, 8, 11, 10, 13]}>
          ...
          >
            ...
            <Text noSpacingBottom variant="primary">
              I was a procurement professional before becoming a web developer,
              instilling stackable skills like business acumen, commercial
              awareness and project management prowess.
            </Text>
          </Card>
        </Item>
      </Grid>
      ...
      <Grid>
        <Item gridColStart={1} gridColEnd={[9, 8, 9, 8, 6]}>
          ...
          <Text variant="tertiary">
            ...
            build websites & apps that are accessible, performant, scalable and
            lightning fast.
          </Text>
          <Text noSpacingBottom variant="tertiary">
            I enjoy a modern tech stack based around React.js, and am
            continuously adding new skills to my toolbox. A committed developer

    ...
    <Section variant="primary">
      <Grid>
        ...
        >
          ...
          <ul>
            <Text as="li" variant="primary">
              Tom Hendra needs to perform a contract with you
            </Text>
            <Text as="li" variant="primary">
              You have given Tom Hendra permission to do so
            </Text>
            <Text as="li" variant="primary">
            ...
            <Text as="li" variant="primary">
              Tom Hendra needs to comply with the law
            </Text>
          </ul>
          <Text variant="primary">
            Tom Hendra will retain your personal information only for as long as
        ...
        >
          ...
          <Text variant="primary">
            tomhendra.dev follows a standard procedure of using log files. These
        ...
        >
          ...
          <Text variant="primary">
            ...
            advertising partners of tomhendra.dev.
          </Text>
          <Text variant="primary">
        ...
        >
          ...
          <Text variant="primary">
            ...
            other than this website. Our GDPR Privacy Policy was generated from
            the&nbsp;
            <InlineLink externalLink="https://gdprprivacypolicy.net">
